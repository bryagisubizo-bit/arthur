...
export const apiCatalogue: CatalogueCategory[] = [
  ...
  { id: "security", name: "Defensive security & compliance", function: "Defensive package, posture, and alerting checks only; never scanning, bypass, exploitation, or credential collection.", providers: ["Snyk", "Vanta", "HackerOne", "Keeper Security", "VirusTotal", "AbuseIPDB", "Cloudflare", "SecurityTrails"], auth: "Review required", owner: "Review required", reviewRequired: true },
