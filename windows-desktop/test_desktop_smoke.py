...
def main():
    ...
    assert "focus zone" in window.spatial_page.context_focus_label.text().lower()
    assert "x 0 / y 0 / z 300" in window.spatial_page.context_focus_label.text().lower()
    assert "periphery" in window.spatial_page.context_zone_label.text().lower()
    assert "ambient" in window.spatial_page.context_zone_label.text().lower()
    assert "arthur.coordinate.v1" in window.spatial_page.context_coordinate_label.text()
    assert "transport closed" in window.spatial_page.context_coordinate_label.text().lower()
    ...
    assert "disabled" in window.spatial_page.multimodal_status.text().lower()
